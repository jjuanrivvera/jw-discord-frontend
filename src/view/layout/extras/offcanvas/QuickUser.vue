    ...
    >
      <div class="d-flex flex-column text-right pr-3">
        <span
          ...
          >{{ currentUserPersonalInfo.username }}</span
        >
        <!--<span
      ...
      >
        ...
        <div class="d-flex align-items-center mt-5">
          ...
          <div class="d-flex flex-column">
            ...
            <!--<div class="text-muted mt-1">Application Developers</div>-->
            <div class="navi mt-2">
...
import { GET_PERSONAL_INFO } from "@/core/services/store/profile.module";
...
export default {
  ...
  async mounted() {
    ...
    await this.$store.dispatch(GET_PERSONAL_INFO);
  },
  methods: {
    onLogout() {
      this.$store
  ...
  computed: {
    ...mapGetters(["currentUserPersonalInfo", "isAuthenticated"]),

    avatar() {
      return `https://cdn.discordapp.com/avatars/${this.currentUserPersonalInfo.id}/${this.currentUserPersonalInfo.avatar}`;
    },
